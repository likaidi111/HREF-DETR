...
@register
@serializable
class LSFEM(nn.Layer):
    """
    LSFEM: Large-Scale Feature Enhancement Module
    ...
    def forward(self, feats):
        ...
        # ==================== 步骤1: 输入投影 ====================
        x = self.input_proj(c3)  # [B, 512, H/8, W/8]
...
class LSFEM_Lite(nn.Layer):
    ...
    def __init__(self,
                 ...
                 out_channels=512,
                 act='silu'):
        super(LSFEM_Lite, self).__init__()
